...
<head>
    ...
    <title>Results from searching</title>
        ...
        <div class="category-menu">
            <ul>
                ...
                <li class="dropdown">
                    <a href="#">Accessory</a>
                    <ul class="dropdown-content">
                        <?php if (!empty($accessories_categories)): ?>
...
<main>
    <h2>Results from searching: "<?php echo htmlspecialchars($search_query); ?>"</h2>
